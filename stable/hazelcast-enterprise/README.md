...
| `livenessProbe.endpoint`                   | URL path that will be called to check liveness.                                                                | `/hazelcast/health/node-state`                       |
...
| `readinessProbe.endpoint`                  | URL path that will be called to check readiness.                                                               | `/hazelcast/health/node-state`                       |
